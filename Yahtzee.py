...
def rollTheDice():
    ...
    print("De cijfers die je hebt gerolt zijn: "+ str(roll1) +", "+ str(roll2) +", "+ str(roll3) +", "+ str(roll4) + " en "+ str(roll5))
    print("Geef aan welke positie(s) je nog een keer wilt rollen of typ 'geen' als je niet nog een keer wilt rollen (voorbeeld van een input: 1 2 5)")
    whatreroll = input("")
...
print("Welkom bij yahtzee! Veel geluk en veel plezier :D")
print("")
...
while True:
    ...
    print("Hier is de lijst die je tot nu toe hebt")
